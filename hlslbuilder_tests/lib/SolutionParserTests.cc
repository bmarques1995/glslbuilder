...
namespace HLSLBuilder
{
	...
	TEST(HLSLBuilder, InvalidArrayHLS2)
	{
		...
		ASSERT_THROW(HLSLBuilder::SolutionParser::LoadProject(parsedControlArgs.m_SolutionFilepath), HLSLBuilder::InvalidArrayException);
	}
